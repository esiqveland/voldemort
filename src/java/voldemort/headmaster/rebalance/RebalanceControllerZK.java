...
import voldemort.client.rebalance.*;
 ...
 *
 */
public class RebalanceControllerZK {

    private static final Logger logger = Logger.getLogger(RebalanceControllerZK.class);
    ...
    public RebalanceControllerZK(String bootstrapUrl,
